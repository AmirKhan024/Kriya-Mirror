...
const WARNING_LABEL: Record<WarningType, string> = {
  ...
  'arm-lift': 'Arm lift',
  'goblet-elbows-collapsing': 'Goblet elbows collapsing',
  'hip-drop': 'Hip drop',
  'hip-lift-off': 'Hip lift off',
  'hip-rotation-curtsy': 'Hip rotation curtsy',
  'incomplete-bird-dog': 'Incomplete bird dog',
  'incomplete-bridge': 'Incomplete bridge',
  'incomplete-clamshell': 'Incomplete clamshell',
  'incomplete-curtsy-lunge': 'Incomplete curtsy lunge',
  'incomplete-dead-bug': 'Incomplete dead bug',
  'incomplete-dip': 'Incomplete dip',
  'incomplete-donkey-kick': 'Incomplete donkey kick',
  'incomplete-drive': 'Incomplete drive',
  'incomplete-extension': 'Incomplete extension',
  'incomplete-fire-hydrant': 'Incomplete fire hydrant',
  'incomplete-goblet-squat': 'Incomplete goblet squat',
  'incomplete-inchworm': 'Incomplete inchworm',
  'incomplete-jump': 'Incomplete jump',
  'incomplete-jump-squat': 'Incomplete jump squat',
  'incomplete-nordic-curl': 'Incomplete nordic curl',
  'incomplete-pallof-press': 'Incomplete pallof press',
  'incomplete-pistol-squat': 'Incomplete pistol squat',
  'incomplete-plank': 'Incomplete plank',
  'incomplete-reverse-fly': 'Incomplete reverse fly',
  'incomplete-shrug': 'Incomplete shrug',
  'incomplete-star-jump': 'Incomplete star jump',
  'incomplete-step-up': 'Incomplete step up',
  'incomplete-superman': 'Incomplete superman',
  'incomplete-tricep-extension': 'Incomplete tricep extension',
  'incomplete-walking-lunge': 'Incomplete walking lunge',
  'knee-valgus': 'Knee valgus',
  'no-jump': 'No jump',
  'no-loading': 'No loading',
  'squat-pattern': 'Squat pattern',
  'steps-not-tracked': 'Steps not tracked',
  'stiff-landing': 'Stiff landing',
  'torso-rotation-pallof': 'Torso rotation pallof',
