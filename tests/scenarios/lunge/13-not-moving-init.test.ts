/**
 * Regression test for round-5 §3.7 init-on-cal-confirm fix on Lunge. Same
 * pattern as squat's 13-test: `standingSince = 0` at construction caused the
 * first post-cal frame to report `idleMs = (now - 0)` = millions, instantly
...
describe('Lunge — regression: no immediate "not-moving" after calibration (2026-05-25)', () => {
