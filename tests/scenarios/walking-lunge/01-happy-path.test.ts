...
// 2.2 s calibration (standing, feet hip-width, arms at sides), then N steps
...
describe('Walking Lunge — happy path', () => {
  it('calibrates within 2.2s and counts 6 alternating steps', () => {
  ...
  it('counts 4 steps when given a 4-step stream', () => {
