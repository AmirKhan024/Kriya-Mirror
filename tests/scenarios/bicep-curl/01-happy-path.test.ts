...
// 2.2 s calibration in EXTENDED position (arms at sides), then N reps. Each rep:
//   0–1000 ms : curl 0° → 130° elbow flex
//   1000–1500 : hold at top
//   1500–2500 : lower 130° → 0°
//   2500–3000 : rest extended
...
describe('Bicep Curl — happy path', () => {
  it('calibrates within 2.2s and counts 10 perfect reps', () => {
    const { totalMs, intentAt } = happyPathIntent(10);
    const frames = buildFrames(intentAt, buildBicepCurlPose, { fps: 30, durationMs: totalMs });
